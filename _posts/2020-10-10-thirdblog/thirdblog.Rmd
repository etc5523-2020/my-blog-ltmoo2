...
Secondly, styling options outside the default offering of shiny and ggplot2 were able to be implemented successfully. This allowed for greater customisation of the appearance of the app to create better visual appeal. This involved the use of an additional programming language, CSS, for the structure of the app itself and the use of ggplot2’s themes options for the plots. This helped develop my familiarity and experience using these options to construct better data visualisations. Additionally, further practice with the kableExtra package was gained in designing tables in alignment with the principles outlined by Schwabish (2020).  
