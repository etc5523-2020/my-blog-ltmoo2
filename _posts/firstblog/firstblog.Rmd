...
arg_data_clean <- arg_data %>%
  ...
  select(country, date, confirmed, daily_confirmed, deaths, daily_deaths, recovered, daily_recovered, daily_active, active, soc_dist:apple_mtr_walking, gcmr_retail_recreation:gcmr_residential)
```
